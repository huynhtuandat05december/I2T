...
from utils.helper import read_image_width_height, display_images_and_text, resize_long_edge
import argparse
...
class ImageTextTransformation:
    ...
    def init_models(self):
        ...
        self.region_semantic_model = RegionSemantic(device=self.args.semantic_segment_device, image_caption_model=self.image_caption_model, sam_arch=self.args.sam_arch)
